        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Validate a customer</h1>
...
<?php 
      if(isset($_POST['submit'])) {
            ...
            $stmt->execute($values);
            echo '<script type="text/JavaScript">window.location.replace("personal_page.php?page=customers")</script>';

      }
            else 
            $welcome_message= 'Edit user';
            require '../nonpublic/admin/admin_edit_customers_form.php';
?>
