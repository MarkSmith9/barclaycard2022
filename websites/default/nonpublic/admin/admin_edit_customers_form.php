            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form autocomplete="off" method="POST" action="personal_page.php?page=edit_customers">
                            ...
                            <div class="form-group row">
                                ...
                                <!-- <div class="col-sm-6">
                                    <input type="text" class="form-control form-control-user" name="role" placeholder="Role" value="<?php if(isset($user['role'])) echo $user['role']?>">
                                </div> -->
                            ...
                            <hr>
                            <input type="submit" class="btn btn-primary btn-user btn-block" name="submit" value="Edit">
