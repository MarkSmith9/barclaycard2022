        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Edit a category</h1>
                    <div class="d-flex justify-content-between">
                        <h5 class="m-0 font-weight-bold text-primary"></h5>
                        <button class="btn btn-lg btn-primary" type="button" onclick="parent.location='personal_page.php?page=categories'">Back</button>
                    </div>
                    

<?php 
      if(isset($_POST['submit'])) {
            $stmt = $pdo->prepare('UPDATE sys.categories 
                                          SET name = :name,
            ...
            $welcome_message= 'Edit category';
            require '../nonpublic/admin/admin_edit_category_form.php';
?>
